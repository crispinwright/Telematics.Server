...
public class MainActivity extends Activity implements GPSTrackingListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(_connectionTask == null) {
        	_connectionTask = new ConnectionTask(_imei);  
        }
        
        _connectionTask.execute(new Location[]{_gpsTracking.getLastLocation()});
    }
	...
	public void onChangeLocation(Location location) {	
    	...
    	_connectionTask.execute(new Location[]{location});
	} 
}
